...
export default function StudyModePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-4 sm:py-6 sm:px-6 lg:px-8 flex flex-col h-[calc(100vh-6rem)]">
      {/* Header */}
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2 sm:mb-8">
        <Link
          href={`/decks/${id}`}
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full relative min-h-0">
        ...
        {/* Spacer on mobile to offset fixed footer so card centres in visible area */}
        <div className="h-40 sm:hidden shrink-0" aria-hidden="true" />
